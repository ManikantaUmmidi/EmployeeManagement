...
<title>configuring leaves</title>
	...
	<div class="page-in">
		<div class="page">
			<div class="main">
				...
				<center>
				<h2>Cofiguring Leaves</h2>
					<div class="container">

                    <form action="SaveLeavesServlet" method="post">
						<table>
							<tr>
								<td><input type="text" placeholder="casula leaves" id="name" name="casualleaves" tabindex="1"></td>
								</tr>
								<tr>
								<td> <input type="text" placeholder="medical leaves" id="phone" name="medicalleaves" tabindex="3"></td>
								</tr>
								<tr>
								<td> <input type="text" placeholder="earned leaves" id="phone" name="earnedleaves" tabindex="3"></td>
								</tr>
