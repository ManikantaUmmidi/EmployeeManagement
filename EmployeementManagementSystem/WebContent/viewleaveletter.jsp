			...
			<div class="main">
				...
				<h2>View Application Letter</h2>
					...
					<div class="container">
						...
						<a href="ViewAllLeaveLettersServlet?pagename=/viewleaveletters.jsp" class="btn2">Go Back</a> &nbsp;&nbsp;<a href="ApproveLeave?empId=${leave.getEmpId()}&pagename=/adminhome.jsp" class="btn2">Approve</a>&nbsp;&nbsp;<a href="RejectLeaveServlet?empId=${leave.getEmpId()}&pagename=/adminhome.jsp" class="btn2">Reject</a>
					</div>
