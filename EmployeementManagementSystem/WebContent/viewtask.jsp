	...
	<div class="page-in">
		<div class="page">
			<div class="main">
				...
				<center>
				<h2>${model.getHeading()}</h2>
					<div class="container">
					

							
							
					<textarea rows="5"  style="width:60%;height:100px" cols="10" >${model.getDescription()}</textarea>
					
						
					
						
					</div>
                     <a href="DeleteMessage?id=${model.getId()}" class="btn2">delete</a>
                  </center>
				</div>
			</div>
