...
<div class="row1">
<%GetUserFromSession.getUsernameFromSession(request);%>
...
<ul>
  <li><a href="ViewAllEmps_HrsServlet">View All Employees</a></li>
  <li><a href="confleaves.jsp">Configure Leaves</a></li>
  <li><a href="confSal.jsp">Configure Salary
 <% int list = Hr_EmployeeDBOperations.getEmpSalNotConf();
        if(list != 0)
        {
 %>
  &nbsp; <b style="color:red;font-size: 15px;">(<%=list%>)</b>
  <%} %>
  </a></li>
  <li><a href="ViewAllEmps_HrsServlet?pagename=paysal.jsp">Pay Salary</a></li>
  <li><a href="assingtask.jsp">Send Message</a></li>
  <li><a href="sendnotice.jsp">Send Notice</a></li>
  <li><a href="ViewAllLeaveLettersServlet?pagename=/viewleaveletters.jsp">Leave Letters</a></li>
...
<div class="contact">
<a href="AdminLogoutServlet"><h2 class="sidebar2" style="color:black">Logout</h2></a>
