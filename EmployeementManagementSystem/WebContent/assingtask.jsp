				...
				<h2>Assign Task</h2>
					<div class="container">
						...
						<table>
								...
								<tr>
								<td><input  style="width:140%" type="text" placeholder="Enter employee id 
									name="email" required></td>
								<td><input type="text"  placeholder="Enter End Date"></td>
								
							</tr>
							<tr>
							<td><textarea rows="5" style="width:200%" placeholder="enter description" cols=""></textarea></td>
							</tr>
						</table>
						<button type="submit" class="btn2">Assign</button>
					</div>
