...
<ul>
  <li><a href="HrViewAllEmployeesServlet">View All Employees</a></li>
  <%  int id2=(Integer)GetUserFromSession.getIdFromSession(request); 
  if(id2!=0)
  {
  %>
 <li><a href="ViewHr_EmpServlet?id=<%=id2%>&pagename=hrprofile.jsp">View My Profile</a></li>
 <%} %>
  <li><a href="sendmessagehr.jsp">Send Message</a></li>
  <li><a href="ViewAllLeaveLettersServlet?pagename=/viewleaveletters_hr.jsp">Leave Letters</a></li>
  <li><a href="hrleaveapply.jsp"><span>apply leave</span></a></li>
  <li><a href="ViewAllLeaves_EmpsServlet?pagename1=/hrleavestatus.jsp&pagename2=/hrhome.jsp"><span>View My Leave Status</span></a></li>
  <li><a href="monthsforattendance_hr.jsp"><span>View My Attendance</span></a></li>
</div>
<div class="contact">
<a href="HrLogoutServlet"><h2 class="sidebar2" style="color:black">Logout</h2></a>
